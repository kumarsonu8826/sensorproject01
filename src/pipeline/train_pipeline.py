...
from src.coponents.data_ingestion import DataIngestion
from src.coponents.data_transformation import DataTransformation
from src.coponents.model_trainer import ModelTrainer
...
class TrainingPipeline:
    def start_data_ingestion(self):
        try:
            ...
            feature_stora_file_path= data_ingestion.initiate_data_ingestion()
            return feature_stora_file_path
    ...
    def run_pipeline(self):
        try:
            ...
            print("training competed. Trained model score:",  r2_square)
