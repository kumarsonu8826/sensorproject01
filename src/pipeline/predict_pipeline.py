...
class PredictionPipelineConfig:
    ...
    modul_file_path:  str = os.path.join(artifact_folder,'model.pkl')
...
class PredictionPipeline:
    ...
    def predict(self,features):
        try:
            ...
            model= self.utils.load_object(self.prediction_pipeline_config.modul_file_path)
    ...
    def get_predicted_dataframe(self, input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            prediction_column_name: str = TARGET_COLLUMN
